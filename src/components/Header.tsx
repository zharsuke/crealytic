    ...
    return (
        <div className="navbar bg-base-100">
            ...
            <div className="sm:hidden">
                <div className="dropdown">
                    ...
                    <ul tabIndex={0} className="menu menu-sm dropdown-content mt-10 z-[1] right-0 top-0 p-3 shadow bg-base-100 rounded-box w-52">
                        <li><Link className={hover} href={'/scripting'}>Scripting</Link></li>
                        <li><Link className={hover} href={'/transcription'}>Transcription</Link></li>
            ...
            <div className="hidden sm:block flex gap-4">
                <Link className={`mr-3 ${hover}`} href={'/scripting'}>Scripting</Link>
                <Link className={`mr-3 ${hover}`} href={'/transcription'}>Transcription</Link>
